...
aiClient = None
##> ------ Contribution Note: Feature (contributor info removed) ------
    ...
    for Question in all_questions:
        ...
        if select:
            ...
            if overwrite_previous_answers or selected_option == "Select an option":
                ##> ------ Contribution Note: Added fuzzy logic to answer location based questions (contributor info removed) ------
        ...
        if text: 
            ...
            if not prev_answer or overwrite_previous_answers:
                ...
                elif ('hear' in label or 'come across' in label) and 'this' in label and ('job' in label or 'position' in label): answer = "(project repo link removed)"
...
def main() -> None:
    pyautogui.alert("Please consider supporting the project (link removed).\n\n", "Support the project", "Okay")
    total_runs = 1
    try:
